...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onFileChange: function onFileChange(event) {
      ...
      var reader = new FileReader(); // Processing to be executed when the file has been read
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                _this2.commentContent = ''; // Remove error notification

                _this2.commentErrors = null; // Other error
  ...
  methods: {
    ...
    onLikeClick: function onLikeClick(_ref) {
      ...
      if (!this.$store.getters['auth/check']) {
        alert('Log in to use like function');
        return false;
      }
            ...
            _c(
              "a",
              {
                ...
                attrs: {
                  ...
                  href: "/api/photos/" + _vm.item.id + "/download"
                },
                on: {
                  click: function($event) {
          ...
          _c("div", { staticClass: "photo-detail__pane" }, [
            ...
            _c(
              "a",
              {
                staticClass: "button",
                attrs: {
                  href: "/api/photos/" + _vm.photo.id + "/download",
                  title: "Download photo"
                }
              },
              [
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("p", [_vm._v("System error occur")])
}
var staticRenderFns = []
render._withStripped = true
...
window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // Add header indicating that it is an Ajax request
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); // Path and component mapping
...
var OK = 200; // Created user success

var CREATED = 201; // Internal server

var INTERNAL_SERVER_ERROR = 500; // 422 error

var UNPROCESSABLE_ENTITY = 422; // 419 error unauthorized

var UNAUTHORIZED = 419; // 404 Page not found
...
module.exports = __webpack_require__(/*! /var/www/html/vue/resources/js/app.js */"./resources/js/app.js");
